...
function Home(){
    return(
        <section className='w-full h-screen'>
            ...
            <div className='relative  md:flex justify-evenly itmes-center mb-10'>
            <div>
                 <div className='bg-gray-200 shadow-2xl rounded-xl py-12 mx-10 mb-10 md:mx-0 px-10 text-center justify-evenly flex-col  text-xl text-indigo-700 items-center'>
